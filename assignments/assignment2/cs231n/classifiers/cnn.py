...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        conv_output_dim = H // 2  # After 2x2 pooling
        self.params['W2'] = np.random.randn(num_filters * conv_output_dim * conv_output_dim, hidden_dim) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        hidden_out, hidden_cache = affine_relu_forward(conv_out, self.params['W2'], self.params['b2'])
